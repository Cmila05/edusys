    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-12 d-md-none">
                ...
                <div class="form-group">
                    {{ Form::label('rol') }}
                    {{ Form::select('rol', $roles, optional($roles)->id, ['class' => 'form-control' . ($errors->has('roles') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione el Rol']) }}
             ...
             <div class="col-md-6 d-none d-md-block">
                ...
                <div class="form-group">
                    {{ Form::label('rol') }}
                    {{ Form::select('rol', $roles, $userRoles, ['class' => 'form-control' . ($errors->has('rol') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione el Rol']) }}
                    {!! $errors->first('rol', '<div class="invalid-feedback">:message</div>') !!}
                </div>
                <div class="form-group">
